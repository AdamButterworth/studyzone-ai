      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/60 bg-white/70 px-8 py-10 shadow-xl shadow-black/5 backdrop-blur-xl">
          ...
          >
            ...
            <button
              type="submit"
              className="mt-3 w-full rounded-xl bg-gradient-to-r from-[#7C5CFC] to-[#5B8DEF] py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
              Continue
            </button>
          </form>
          ...
          {/* Google */}
          <a href="/app" className="flex w-full items-center justify-center gap-3 rounded-xl border border-black/10 bg-white py-3 text-sm font-medium transition-colors hover:bg-cream-dark/50">
